...
urlpatterns = [
    ...
    path('embedding', EmbeddingView.as_view()), #una lista di stringhe viene convertita in vettori e viene stored nel db # embedd/store
    ...
    path('indexretrieval', IndexRetrivalView.as_view()), #data una domanda ritorna i documenti più rilevanti # document/retri
